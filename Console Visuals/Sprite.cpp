...
{
	//creating a dynamic array of size 10 of arrays
	
	/* previously used to populate instance variable pixels_, this is now done as the file is read
	for (int i = 0; i < 10; i++)
	{
		pixels_[i] = new Pixel[10];
	}*/
	rows_ = 0;
	cols_ = 0;
	//pixels_ = new Pixel * [1];
